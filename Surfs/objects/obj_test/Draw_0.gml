...
A Gamemaker library that handles all the hassle related to creating and managing surfaces
*/

var name = "testsurfname";

Surfs(name,room_width/3,room_height/3,
[function(){return Surfs_width("testsurfname")>400},-1]);
...
draw_rectangle(room_width/2-200,room_height/2-room_height/6-200,room_width/2+200,room_height/2+room_height/6+200,1);


//Test resizing
if(keyboard_check(vk_up)){
   surfw++; surfh++;
   Surfs_resize(name,max(surfw,0),max(surfh,0));
}
